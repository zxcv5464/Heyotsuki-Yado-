-- Roll back batch draft saving and restore the original minimum-only
-- automatic assignment target.
drop function if exists public.save_roster_assignment_draft(uuid, jsonb);
